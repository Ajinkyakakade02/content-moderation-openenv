...
if __name__ == '__main__':
    ...
    print(f"🤖 AI Models: {'✅ LOADED' if AI_AVAILABLE else '❌ NOT AVAILABLE'}")
    print("")
    print("📝 DETECTION CAPABILITIES:")
    print("   🔪 VIOLENCE: Fight, Kill, Blood, Weapons, Attack")
    print("   🔞 NUDITY: Naked, Sexual, Bikini, Lingerie, Revealing")
    print("   😡 ANGER: Hate speech, Profanity, Aggression")
    print("   👗 SHORT CLOTHES: Bikini, Short skirts, Revealing outfits")
    print("   🎬 VIDEO: Frame-by-frame analysis for ALL violations")
    print("   🖼️ IMAGE: Full AI analysis for nudity and violence")
    print("   📝 TEXT: Keyword detection for ALL categories")
    print("=" * 60)
